                ...
                {productsLoading ? (
                  ...
                  <ul className="flex flex-col divide-y divide-stone-100">
                    ...
                    {searchResults.map((product) => {
                      ...
                      // =================================================
                      // IMPORTANT:
                      // resolveImage supports BOTH:
                      //
                      // 1. Cloudflare R2 complete URL
                      // 2. Old Render/backend relative path
                      // =================================================
      ...
      >
        ...
        <div className="border-t border-stone-200 pt-5 text-center">
          ...
          <p className="text-[9px] uppercase tracking-[0.2em] text-stone-400 mt-0.5">
            Inspired by the world's finest perfume traditions, our
            creations celebrate sophistication, individuality, and
            enduring luxury.
          </p>
      ...
      >
        ...
        <div className="border-t border-stone-200 px-6 md:px-10 py-8 bg-white text-center">
          ...
          <p className="mt-4 text-[11px] leading-6 tracking-[0.08em] text-stone-500 max-w-[280px] mx-auto">
            ...
            Discover a world where artistry meets luxury, and every scent
            tells a story.
          </p>
